...
# ====================================InlineHandler===================================== #
        ...
        async def on_plug_in_callback_query_handler(event):
            if event.query.user_id == uid:
                text = (
                    f"❁ __Saya Adalah Skyla Userbot Yang Digunakan Banyak User Telegram__.\n\n"
                    f"❁ __Saya Dibuat Hanya Untuk Bersenang Senang Ditelegram__.\n\n"
                    f"❁ __Kelebihan Saya Banyak, Saya Mempunyai 187 Modules__.\n\n"
                    f"© @skylasupport")
                await event.edit(
                    text,
                    file=kyylogo,
        ...
        async def on_plug_in_callback_query_handler(event):
            if event.query.user_id == uid:
                text = (
                    ...
                    f"°__Mengganti Teks Yang Ada Command skyalive__.\n\n"
                    f"© @skylasupport")
                await event.edit(
                    text,
                    file=kyylogo,
