...
UPSTREAM_REPO_URL = os.environ.get(
    "UPSTREAM_REPO_URL",
    "https://github.com/izzafthni/Skyla-Userbot")
...
with bot:
    try:
        ...
        LOGS.info(
            "Join Support Group @skylasupport and Channel @SkylaIND to see the updates of userbot"
            "Don't Leave")
        quit(1)
