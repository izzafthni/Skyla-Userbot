...
async def _(event):
   ...
   # input_str = event.pattern_match.group(1)
    ...
    animation_chars = [
        ...
        "INFO - Skyla-Userbot: Logged in as 557667062",
        "INFO - Skyla-Userbot: Successfully...",
        "919852+00:00 app[worker.1]: 919 - Skyla-Userbot -",
        "INFO -  ☃️Skyla-Userbot☃️  ⚙️ V7.0 [TELAH DIAKTIFKAN!]",
        "**Build Succeeded**"
