...
import psutil
from userbot import ALIVE_LOGO, ALIVE_NAME, BOT_VER, CMD_HELP, SKYLA_TEKS_KUSTOM, StartTime, UPSTREAM_REPO_BRANCH, bot
...
async def redis(alive):
    ...
    await alive.edit("__Skyla Userbot...__")
    await alive.edit("__Sedang Memuat..__")
    await alive.edit("__DUUUAAAAARRR...__")
    await alive.edit("🐣")
...
CMD_HELP.update({
    "alive":
    "𝘾𝙤𝙢𝙢𝙖𝙣𝙙: `.alive` or `.skylaon` or `.skyalive`"
