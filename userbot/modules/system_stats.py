...
async def amireallyalive(alive):
    ...
    output = (
        ...
        f"╚═══════⋯⋯⋯⋯⋯═══════╝\n"
        f"[𝗚𝗿𝗼𝘂𝗽](https://t.me/skylasupport) | [𝗣𝗲𝗺𝗶𝗹𝗶𝗸](https://t.me/{user.username}) | [𝗖𝗵𝗮𝗻𝗻𝗲𝗹](https://t.me/SkylaIND)"
    )
    if ALIVE_LOGO:
        try:
            logo = ALIVE_LOGO
...
async def redis(alive):
    ...
    output = (
        ...
        f"╰┈────────────────────\n"
        f"╭═───────╼⌘╾───────═ \n"
        f"┃[𝗥𝗲𝗽𝗼](https://github.com/Skyla-UserBot)  |  [𝗦𝘂𝗽𝗽𝗼𝗿𝘁](t.me/skylasupport)  |  [𝗜𝗻𝘀𝘁𝗮𝗴𝗿𝗮𝗺](https://Instagram.com/ikyxyzu)\n"
        f"╰═──────╼═⌘═╾───────═"
    )
    if ALIVE_LOGO:
        try:
